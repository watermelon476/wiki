...
insert into `category`(id, parent, name, sort) values (502,500,'开发工具',301);
...
create table `doc`(
   ...
   primary key (`id`)
)engine =innodb default character set=utf8mb4 comment '文档';
...
values (1,'test123','测试','7354a1d413535a6c0dc5c209e198d799');
